 ...
 *
 * TypeScript version for use in Next.js API routes and server-side code.
 *
 * Usage:
 * ```ts
 * import { echoConstraints } from '@/lib/constraint-echo'
 *
 ...
 *
 * Reads the log file and returns a summary.
 */
